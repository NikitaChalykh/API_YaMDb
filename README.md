...
Проект разворачивается в трех Docker контейнерах: web-приложение, postgresql-база двнных и nginx-сервер.
...
[Ссылка на размещенный проект](http://nikitachalykh.ddns.net:81/api/v1/)
...
----------
Документация для API [доступна по ссылке](http://nikitachalykh.ddns.net:81/redoc/) после установки приложения.
